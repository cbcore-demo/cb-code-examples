...
procedure 'Parse Jenkins Log', {
  ...
  formalParameter 'build_number', defaultValue: '', {
    description = 'Build number. (if a build number is not provided, the build number will be the last one).'
    expansionDeferred = '0'
    label = null
    orderIndex = null
    required = '0'
...
$request->method(\"GET\");
$request->url(\"$[host]/job/$[job_path]/$[build_number]/consoleText\");
...
print $response->as_string;'''
  ...
  <formElement>
    ...
    <documentation>Build number. (if a build number is not provided, the build number will be the last one).</documentation>
    <type>entry</type>
    <required>1</required>
  </formElement>
